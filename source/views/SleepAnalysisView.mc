...
class SleepAnalysisView extends WatchUi.View {
    ...
    function initialize() {
        ...
        System.println("SleepAnalysisView initialized");
    }
    ...
    function onShow() as Void {
        System.println("SleepAnalysisView onShow");
    ...
    function startAnalysis() as Void {
        if (!analysisStarted) {
            ...
            System.println("SleepAnalysisView: Requesting analysis start");
        }
    }
