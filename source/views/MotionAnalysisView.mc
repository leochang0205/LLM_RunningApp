...
class MotionAnalysisView extends WatchUi.View {
    ...
    function initialize() {
        ...
        System.println("MotionAnalysisView initialized");
    }
    ...
    function onShow() as Void {
        System.println("MotionAnalysisView onShow");
    ...
    function startAnalysis() as Void {
        if (!analysisStarted) {
            ...
            System.println("MotionAnalysisView: Requesting analysis start");
        }
    }
